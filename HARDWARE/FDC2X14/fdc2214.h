...
//相关函数申明
u8 Set_FDC2214(u8 reg,u8 MSB,u8 LSB);//FDC2214设置函数
u16 FDC_Read(u8 reg);//读取FDC2214寄存器数据
//u16 FCD2214_ReadCH(u8 index);
u32 FCD2214_ReadCH(u8 index);//读取FDC2214通道数据

u8 FDC2214_Init(void);//FDC2214初始化函数
float Cap_Calculate(u8 index);//测量线路电容
